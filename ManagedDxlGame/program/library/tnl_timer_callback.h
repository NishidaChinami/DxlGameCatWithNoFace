...
public :
	uint32_t count = 0;
	tnl::timer_Callback<Test> tc = tnl::timer_Callback<Test>(this, &Test::call, 1.0f);
...
void gameMain(float delta_time) {
	...
	*/
	...
	public:
		...
		//===================================================================================
		timer_Callback( T* obj, const std::function<void(T*, const float)> func, const float regulation_time, const bool is_callback_start = false )
