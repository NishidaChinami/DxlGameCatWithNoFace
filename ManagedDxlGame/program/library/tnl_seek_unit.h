...
namespace tnl {
	...
	public:
		...
		SeekUnit(const double fix_fps
			...
			setTotalFrameNum(total_frame_num_);
		...
		// getter
		//
		inline uint32_t getTotalFrameNum() { return total_frame_num__; }
	...
	private:
		...
		// 総フレーム数の設定
		void setTotalFrameNum(const uint32_t frame_num_ = 0);
